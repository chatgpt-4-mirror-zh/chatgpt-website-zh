# 国内可用的 免费中文版 ChatGPT镜像网站整理合集【11月持续更新】 

本项目持续更新，为大家整理提供国内可用的 ChatGPT镜像网站、免费ChatGPT中文版的免费服务，汇总了多个ChatGPT镜像网站，包括GPT4、GPT-4o、o1、AI写作、AI PPT、AI绘画等功能。

给大家整理的国内可以直接用的 ChatGPT中文版镜像网站，无需翻墙就能直接使用。

## 什么是镜像网站？

镜像站（Mirror Site）是通过将原网站内容，进行复制，创建的备用网站。为因特殊情况（如翻墙等）无法直接使用的地区，提供相同或类似的服务和信息。
特别是在国内，ChatGPT 官网是打不开的，那么可以使用镜像站就可以啦~~~
